...
- - 当然这些组件不是必选的
  ...
  - - 后端服务集群的配置，
    ...
    - - 是真实的服务器，一个Backend对应一个或者多个实体服务器。
...
\#获得客户端IP
  ...
  acl       denali_policy       hdr_reg(host) -i ^([www.gemini.taobao.net](http://www.gemini.taobao.net/)|my.gemini.taobao.net|auction1.gemini.taobao.net)$
