...
zabbix_host = '10.x.6.124'   # Zabbix server IP
zabbix_port = 10051         # Zabbix server port
hostname = '10.x.3.12'   # Name of monitored host, like it shows in zabbix web ui
time_delta = 1              # grep interval in minutes

# URL to nginx stat (http_stub_status_module)
stat_url = 'http://www.x.com/nginx_stat'

# Nginx log file path
nginx_log_file_path = '/data/logs/nginx/access.log'
